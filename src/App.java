...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        if (len < 8 || len > 16) {
            System.out.println("Please try again and input a valid password with a length between 8 and 16");
            System.exit(0);
        }
        ...
        if (count.size() < 3) {
            System.out.println("Please try again and input a valid password with a combination of at least 3 different categories of letters");
            System.exit(0);
        }

        System.out.println("Your password satisfies all the requirements");
    }
}
